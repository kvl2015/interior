...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function dataTypesTranslations()
    {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.categories.singular'))->firstOrFail();
        if ($dtp->exists) {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.categories.plural'))->firstOrFail();
        if ($dtp->exists) {
