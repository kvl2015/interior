...
class ProductExportVaughan implements FromCollection
{
    /*
ls -l /home/select-interiorworld/selectinter/storage /home/select-interiorworld/public_html
    ...
    */
    public function collection()
    {
        ...
        $productsData = array();
        for ($i = 1; $i<=2; $i++) {
            $link = 'https://www.vaughandesigns.com/lighting/outdoor?page='.$i;
            //echo $link.'<br/>';
